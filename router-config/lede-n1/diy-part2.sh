...
# git clone https://github.com/yingkee/ywb94-shadowsocksr-libev package/shadowsocksr-libev
# git clone https://github.com/shadowsocksr-backup/shadowsocksr-libev package/shadowsocksr-libev-bak
